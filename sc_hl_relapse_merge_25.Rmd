...
hl_R.expr.scaled <- GetAssayData(object = hl_relapse.merged, slot = "scale.data")
...
hl_R.components.cluster.avgs.ordered <- hl_R.components.cluster.avgs[ row.names(component.mappings), ]

pheatmap(hl_R.components.cluster.avgs.ordered, 
         annotation_row = component.mappings, 
         cluster_rows = FALSE, annotation_names_row = FALSE, angle_col = 45, gaps_row = c(2,5,10))
