...
```{r}
#metrics.temp <- read.table("~/Documents/sc_HL_relapse/metrics/all.relapse.metrics.csv", sep = ",", header = TRUE, fill = TRUE)
# write out as tabular format so we can remove commas in numbers
#write.table(metrics.temp, "~/Documents/sc_HL_relapse/metrics/all.relapse.metrics.txt", sep = "\t", row.names = FALSE, quote = FALSE)
