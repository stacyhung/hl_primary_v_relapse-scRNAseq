...
VP_by_gene(gene_list = c("CD163", "CD274", "IL3RA", "CD80", "CD86", "CXCL9", "CXCL10", "CXCL11", "CD40", "CCL22", "HAVCR2", "HLA-DRB5", "GZMB"),
...
# 1. pDC cluster: GZB, CD163, CD123 (-> IL3RA), HLA-DRB5
VP_by_gene(gene_list = c("GZMB", "CD163", "IL3RA", "HLA-DRB5"),
         file_name = "~/Documents/sc_HL_relapse/seurat/figures/V4_LATEST/vln_plots/pDC-HL_vs_RLN", 
