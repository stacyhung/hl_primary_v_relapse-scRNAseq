...
DimPlot(hl_all.combined, reduction = "umap", label = TRUE, pt.size = 0.2, group.by = "case.type")
#DimPlot(hl_all.combined, reduction = "umap", label = TRUE, pt.size = 0.2, group.by = "orig.ident")
