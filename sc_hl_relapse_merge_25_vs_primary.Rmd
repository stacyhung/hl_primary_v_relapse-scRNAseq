...
## Merge diagnostic and relapse Seurat objects

```{r}
# this step takes a long time, so make sure you really want to merge when you perform this step!
hl.combined <- merge(hl_diag.merged, hl_relapse.merged, add.cell.ids = c("diagnostic", "relapse"), project = "LSARP-HL")
table(hl_combined$orig.ident)
```
