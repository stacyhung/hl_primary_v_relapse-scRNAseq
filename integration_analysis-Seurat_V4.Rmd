...
# biology
hl_all.combined$biology <- plyr::mapvalues(x = hl_all.combined$orig.ident, 
    from = as.vector(final.cohort$Sample), to = as.vector(final.cohort$Biology)
)
# pathology
...
## #########################################################
## Cluster-level DE analysis: HL (diagnostic + relapse) vs. relapse
## #########################################################
